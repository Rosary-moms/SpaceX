...
const peopleData = { 
   "Ash": { 
     title: "Ash Stowe",
     image: "http://static.wixstatic.com/media/b8f383e0fe2b478ea91362b707ef267b.jpg"
    },
   "Aiden": {
    title: "Aiden Johnson",
    image: "http://static.wixstatic.com/media/ca3c7ac5427e43928aa5f3f443ae2163.jpg"
   },
   "Jess": {
    title: "Jess White",
    image: "http://static.wixstatic.com/media/147fe6f37fe24e83977b4124e41b6d3d.jpg"
   },
   "Morgan": {
    title: "Morgan James",
    image: "http://static.wixstatic.com/media/59e1f2f4dbbc4f7c9d6e66e3e125d830.jpg"
   }
};



export function QRReg_Router(request) {
   ...
   if (data) {
       ...
       // Render item page 
       return ok("QRReg-page", data, seoData); 
   }
...
export function QRReg_SiteMap(sitemapRequest) {
   ...
   const siteMapEntries = Object.keys(peopleData).map((name)=>{
                               ...
                               entry.pageName = "QRReg-page";		// The name of the page in the Wix editor to render
                               entry.url = "/QRReg/" + name ;			// Relative URL of the page
